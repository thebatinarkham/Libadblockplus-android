...
public class MainActivity extends AppCompatActivity implements ComponentCallbacks2
{
  ...
  private void setTestPageSubscription()
  {
    ...
    final Subscription subscription = adblockEngine.getFilterEngine().getSubscription(testPageSubscriptionUrl);
    String message;
    if (adblockEngine.getFilterEngine().getListedSubscriptions().contains(subscription))
    {
    ...
    {
      adblockEngine.getFilterEngine().addSubscription(subscription);
